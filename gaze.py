...
from gaze_eval import gaze_eval
...
# no get_default_path because we know where exactly everything is
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_gaze_annotation(index)
...
###
    ...
    def _write_gaze_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            ...
            filename = self._get_gaze_results_file_template().format(cls)
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_gaze_results_file(all_boxes)
    ...
    def _get_gaze_results_file_template(self):
